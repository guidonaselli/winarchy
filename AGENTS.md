...
## Workflow
- Spec-driven con OpenSpec (`openspec/`, local y no versionado). Cambios no triviales: proposal primero; el `tasks.md` de cada change es el único registro de avance (`openspec list`).
